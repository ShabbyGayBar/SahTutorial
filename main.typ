...
#tip(title: "相干采样")[
  ...
  根据@coherent_sampling 我们可以注意到，FFT频谱是由$N$条"柱子"组成的，它们的*高度*对应相应频率区间内的*信号强度*。而信号对应的"柱子"则是其中左起的第$M+1$根 (第1根是直流分量)。那么无奖竞猜的时候来了：如果$M$改为3.2，FFT频谱中的信号"柱子"
]
...
尽管如此，由于模拟工程师在数量上远远不如数字工程师，VerilogA的使用范围相对较窄，社区也相对萎缩。以至于在简体中文互联网上很难找到关于VerilogA的系统性的教程#footnote[有条件的同学建议参考https://verilogams.com]，你甚至没法在VS Code中找到一个支持给VerilogA做语法高亮的插件。
